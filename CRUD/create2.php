...
<div class="form-group">
	...
	<div class="col-sm-10">
		<input class="form-control" placeholder="Name" type="text" name="Nama" autocomplete="off"><br>
	</div>	
	<label for="inputTelepon" class="col-sm-2 control-label">Telepon</label>
	<div class="col-sm-10">
		<input class="form-control" placeholder="+62878000xxx" type="text" name="Telepon" autocomplete="off">
	</div>
</div>
<div class="form-group">
